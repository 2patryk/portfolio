...
export const globalCopy = {
  ...
  projects: {
    ask: {
      ...
      responsibilities:
        "Led front-end development for the experience: implemented core content, scroll-driven animations, transitions, and accessibility (a11y).",
      assets: [
        {
    ...
    mtd: {
      ...
      responsibilities:
        "Built the moderator admin panel for streamer management and promotion; developed a custom Twitch video plugin to support the initiative.",
      assets: [
        {
    ...
    slimjim: {
      ...
      responsibilities:
        "Delivered UI implementation and animations; owned responsive behaviour for pixel-art–driven layouts across devices.",
    },
    jj: {
      company: "UNIT9",
      categories: [Category.WEBSITE],
      ...
      responsibilities:
        "Implemented the full UI layer, including motion design and page transitions.",
      assets: [
        {
          src: "/videos/jj1.mp4",
          type: "video",
    ...
    wimbledon: {
      ...
      responsibilities:
        "Owned front-end integration with PlayCanvas (WebXR), plus UI and in-app animations.",
      assets: [
        {
          src: "/videos/w1.mp4",
          type: "video",
    ...
    riot: {
      ...
      responsibilities:
        "Implemented the full UI for the mobile experience; first project at UNIT9.",
    },
    fh: {
      company: "LIKI MS",
      categories: [Category.WEBSITE],
      ...
      description:
        "Corporate website for Frontend House, built with Next.js (SSG). The site showcases case studies, a blog, company services, team, and contact information—with a focus on performance and maintainability.",
      responsibilities:
        "Implemented UI, animations, and CMS/backend integration.",
      assets: [
        {
