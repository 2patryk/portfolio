...
export const PANO_DATA: PanoType[] = [
  withPlanet({ src: "/images/pano/pafos.JPG", slug: "white-river-beach", region: PanoRegion.Paphos, country: PanoCountry.Cyprus, categories: [PanoCategory.Beach, PanoCategory.Nature] }),
